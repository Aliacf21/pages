/**
 * ============================================================
 *  SITE CONTENT  —  edit your website text here
 * ============================================================
 *
 *  This is the ONLY file you need to edit to change the words
 *  on the site. Each value below maps to a piece of text on the
 *  page. Just change the text inside the quotes and save.
 *
 *  Tips:
 *   - Keep the quotes "..." around your text.
 *   - To start a new line (e.g. an address), use \n inside the
 *     quotes, like "Line one\nLine two".
 *   - Don't change the names on the left (e.g. hero, title) or
 *     remove commas — only edit the text inside the quotes.
 * ============================================================
 */
